      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-8">
            <Link to="/" className="text-2xl font-bold text-white" style={{ color: '#ff5e78' }}>
              Flyingdarts
            </Link>
            <div className="hidden md:flex space-x-6">
              <Link to="/features" className="text-white hover:text-white/80 transition-colors">Features</Link>
