        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left animate-slide-up">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
              ...
              and perfect your aim in the most immersive online darts experience.
            </p>
            ...
            <div className="flex items-center justify-center lg:justify-start space-x-8 mt-12">
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">Head-to-Head</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-accent">∞</div>
                <div className="text-sm text-muted-foreground">Unlimited Legs</div>
              </div>
              <div className="text-center">
          ...
          <div className="relative animate-float">
            <Card className="relative overflow-hidden border-2 border-primary/20 bg-card/50 backdrop-blur-sm">
              ...
              <div className="absolute bottom-2 right-2 z-10">
                <span className="px-2 py-0.5 text-[10px] leading-none rounded bg-black/70 text-white border border-white/20 shadow-sm backdrop-blur-sm">
                  AI generated
                </span>
              </div>
            </Card>
            ...
            <div className="absolute -top-4 -right-4 animate-pulse-glow">
              <Card className="p-4 text-white" style={{ backgroundColor: '#5a54e3' }}>
